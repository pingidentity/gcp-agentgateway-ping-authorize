 ...
 * the downstream agent (ping-store-agent) to perform token exchange (RFC 8693)
...
const SCOPES = (import.meta.env.VITE_SCOPES as string) || 'openid profile email order-status:invoke';
